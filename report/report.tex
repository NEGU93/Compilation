...
The objective of this project is to create a compiler for a fragment of C denominated \textit{Mini C}. Produce a reasonably effective code x86-64.

\subsection{Mini C}
\subsubsection{What it has}
